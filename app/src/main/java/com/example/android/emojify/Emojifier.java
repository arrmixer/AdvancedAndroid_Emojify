...
//                Emoji(face);
                ...
                // TODO (4): Create a variable called emojiBitmap to hold the appropriate Emoji bitmap and remove the call to Emoji()
                Bitmap emojiBitmap;

                // TODO (5): Create a switch statement on the result of the Emoji() call, and assign the proper emoji bitmap to the variable you created
                switch (Emoji(face)) {
                    case FROWN:
    ...
    private static Emoji Emoji(Face face) {

        // TODO (1): Change the return type of the Emoji() method from void to Emoji.
        // Log all the probabilities
        Log.d(LOG_TAG, "Emoji: smilingProb = " + face.getIsSmilingProbability());
        Log.d(LOG_TAG, "Emoji: leftEyeOpenProb = "
                + face.getIsLeftEyeOpenProbability());
        Log.d(LOG_TAG, "Emoji: rightEyeOpenProb = "
